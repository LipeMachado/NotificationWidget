        ...
        <>
            <div className="w-[448px] rounded overflow-hidden">
                ...
                <div className="bg-zinc-200 dark:bg-zinc-800 py-4 px-6 flex items-center justify-between">
                    ...
                    <button className="text-violet-500 font-bold text-xs hover:text-violet-400 transition-colors">MARCAR TODAS COMO VISTAS</button>
                </div>
                ...
                <div>
                    ...
                    <div className="divide-y-2 divide-zinc-300 dark:divide-zinc-950">
                        ...
                        <Notification.Root>
                            ...
                            <Notification.Content text="Você recebeu um convite para fazer parte da empresa Rocketseat." />
                            <Notification.Actions>
                                <Notification.Action icon={ArrowRight} className="bg-emerald-500 hover:bg-emerald-600 dark:bg-emerald-500 dark:hover:bg-emerald-600" />
                            </Notification.Actions>
                        </Notification.Root>
                    </div>
                </div>
